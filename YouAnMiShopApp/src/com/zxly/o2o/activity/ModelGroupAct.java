...
import com.zxly.o2o.request.GetModelMemberGroupRequest;
...
public class ModelGroupAct extends BasicAct implements PullToRefreshBase.OnRefreshListener {
 ...
 /*   @Override
  ...
  /*public void onResume() {
    ...
    public void loadGroupData(boolean showDialog) {
        final GetModelMemberGroupRequest getMenberGroupRequest = new GetModelMemberGroupRequest(showDialog);
...
//        MainActivity.getIncetance().showKeDDRedPoint();
    ...
    private void loadFansData(final MenberGroupModel MenberGroupModel, boolean isShowLoading) {
        final GetMenberInfoRequest getMenberInfoRequest = new GetMenberInfoRequest(MenberGroupModel.getName());
...
//                convertView=inflateConvertView(R.layout.item_fans_child);
            ...
            cViewHolder.layout_container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    OutLineFansDetailAct.startCallBack(ModelGroupAct.this, menberInfoModel.getId(), refrenshCallBack, clearBehavoirCallBack);
                }
            });
            return convertView;
        }
